...
\frame{\centering \includegraphics[width=0.4\textwidth]{images/qrcode-ti.pdf} \\ \url{https://sites.google.com/site/leolca/teaching/information-theory}}
\frame{\centering \includegraphics[width=0.4\textwidth]{images/qrcode-slides.pdf} \\ \url{https://github.com/leolca/lectures/blob/master/ti/teoria-da-informacao.pdf}}
...
\input{introducao/informacao.tex}
% entropia
\input{entropia/entropia.tex}
\input{entropia/entropiabinaria.tex}
\input{entropia/entropia-conjunta.tex}
\input{entropia/entropia-propriedades.tex}
\input{entropia/informacao-mutua.tex}
\input{entropia/medida.tex}
\input{entropia/entropia-propriedades-2.tex}
\input{entropia/des-proc-dados.tex}
\input{entropia/estatistica.tex}
\input{entropia/fano.tex}
% propriedade da equipartição assintótica / conjunto típico
\input{propeqa/propeqa.tex}
\input{propeqa/propconjtipo.tex}
\input{propeqa/exercicios.tex}
% método de tipos
\input{tipos/method-types.tex}
% processos estocásticos
\input{stochastic/stochastic.tex}
\input{stochastic/markov.tex}
% códigos
\input{coding/coding.tex}
\input{coding/huffman.tex}
\input{coding/shannon-fano-elias.tex}
% huffman adaptativo
%\input{coding/huffmanadapt.tex}
\input{coding/acoding.tex}
\input{coding/lempelziv.tex}
% capacidade de canal
\input{canal/capcanal.tex}
% codigos de correcao de erro
\input{correrro/codes.tex}
% entropia diferencial
\input{continuo/contdifentropy.tex}
% canal gaussiano
\input{continuo/gausschannel.tex}
