...
O receptor recebeu a seguinte sequência: 01011001000011111001.
...
Vamos primeiramente separa os grupos de 7 bits (palavras do código de Hamming 743): 0101100, 1000011, 111001.
...
$s_3 = [0 0 1]^T$: (7a coluna de $H$).

Devemos trocar o último bit e assim obter: 111000. Bits de dados 1110 (hex=E).
