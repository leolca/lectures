...
%%%%%%%%%%% print footnotes on notes slides
...
\input{pca/pca.tex}
% Wavelets
\input{wavelets/wavelets.tex}
% Aquisição de imagem
\input{aquisicao/aquisicao.tex}
% cores
\input{cor/cor.tex}
% Visão
\input{visao/visao.tex}
% Audição
\input{audicao/audicao.tex}
